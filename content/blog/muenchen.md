...
I lived relatively close to work (~10 minutes via U-bahn or ~30 minutes away walking -- I typically walked home after work every day).
I stayed in an area known as Rotkreuzplatz (lit. "Red Cross Square/Area"), which is named after the Red Cross HQ based within this neighbourhood.
It was conveniently located on the U1/7 train line, and the famous [Schloss Nymphenburg](https://en.wikipedia.org/wiki/Nymphenburg_Palace) is about 30 minutes away walking. 
...
<figure style="text-align:center;">
  <img src="/imgs/muenchen/rotkreuzplatz_ubahn.jpg" alt="Rotkreuzplatz U-bahn Station" style="width:90%;margin:auto;">
  <figcaption>Exit of Rotkreuzplatz station (April 4th, 2021)</figcaption>
</figure>
</div>
<div class="column" style="flex: 50%;">
<figure style="text-align:center;">
  <img src="/imgs/muenchen/rotkreuzplatz_ubahn-2.jpg" alt="Rotkreuzplatz U-bahn Station" style="width:90%;margin:auto;">
  <figcaption>Exit of Rotkreuzplatz station (Nov 6th, 2020)</figcaption>
</figure>
</div>
</div>
...
<figure style="text-align:center;">
  <img src="/imgs/muenchen/masks.jpg" alt="Trulli" style="width:60%;margin:auto;">
  <figcaption>"Maximum freedom or minimal risk? Courage decides."</figcaption>
</figure>
...
<div class="row" style="display: flex;flex-wrap: wrap;text-align:center;">
	<div class="column" style="flex: 30%;">
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/herbst.jpg" style="width:90%;margin:auto;">
		</figure>
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/winter.jpeg" style="width:90%;margin:auto;">
		</figure>
	</div>
	<div class="column" style="flex: 30%;">
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/herbst-2.jpg" style="width:90%;margin:auto;">
		</figure>
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/fruhling.jpg" style="width:90%;margin:auto;">
		</figure>
	</div>
	<div class="column" style="flex: 30%;">
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/winter-2.jpg" style="width:90%;margin:auto;">
		</figure>
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/fruhling-2.jpg" style="width:90%;margin:auto;">
		</figure>
	</div>
...
However, I did try a lot of the common things, like Leberkäsesemmel (a sandwich with [Leberkäse](https://en.wikipedia.org/wiki/Leberk%C3%A4se) -- a type of meatloaf), Schnitzelsemmel (a sandwich with [Schnitzel](https://en.wikipedia.org/wiki/Schnitzel) -- flattened and breaded pork cutlet), [Weisswurst](https://en.wikipedia.org/wiki/Weisswurst) and other types of sausages, pretzels.
And of course... [Radler](https://en.wikipedia.org/wiki/Shandy#Radler) and beer.

My favourite food was [Schweinshaxe](https://en.wikipedia.org/wiki/Schweinshaxe)! See below for a nice shot of the Bavarian classic.

<div class="row" style="display: flex;flex-wrap: wrap;text-align:center;">
	<div class="column" style="flex: 50%;">
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/schweinshaxe.jpg" alt="Schweinshaxe" style="width:80%;margin:auto;">
			<figcaption>Schweinshaxe -- Pork Leg!</figcaption>
		</figure>
	</div>
	<div class="column" style="flex: 50%;">
		<figure style="text-align:center;">
			<img src="/imgs/muenchen/weisswurst.jpg" alt="Weisswurst" style="width:80%;margin:auto;">
			<figcaption>Weißwurst!</figcaption>
		</figure>
	</div>
	<figure style="text-align:center;">
		<img src="/imgs/muenchen/leberkase.jpg" alt="Leberkäse" style="width:40%;margin:auto;">
		<figcaption>Leberkäsen (with veggies on the side 🤓)</figcaption>
	</figure>
</div>
...
<figure style="text-align:center;">
  <img src="/imgs/muenchen/memes.jpg" alt="Trulli" style="width:60%;margin:auto;">
  <figcaption>Germans love memes too.</figcaption>
</figure>
