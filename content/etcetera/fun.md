...
<div class="news-tabs">
  ...
  <div class="news-tab-list" role="tablist" aria-label="News by year">
    ...
    <button class="news-tab-btn"        data-year="blue" role="tab" aria-selected="false" aria-controls="panel-listen" id="tab-listen">Must-Watch/Listen 🎬</button>
  </div>
  ...
  <!-- 2021 & Earlier -->
  <div class="news-tab-panel" id="panel-listen" role="tabpanel" aria-labelledby="tab-listen">
    <h3>Random videos I really liked:</h3>
    <ul>
        <li>
            <span><a href="https://youtu.be/8rOU9wrEsoo" target="_blank">Why Donald Glover's Atlanta Feels So Weird</a>
                <p>
                    Really amazing video that talks about why <a href="https://en.wikipedia.org/wiki/Atlanta_(TV_series)" target="_blank">Atlanta</a> is such an amazing show and explains its genre of <a href="https://en.wikipedia.org/wiki/Afro-Surrealism" target="_blank">Afro-surrealism</a>.
                </p>
            </span>
        </li>
        <li>
            <span><a href="https://www.youtube.com/watch?v=epqYft12nV4" target="_blank">The most elegant key change in all of pop music</a>
                <p>
                    I was really diving into lore about the song <a href="https://en.wikipedia.org/wiki/All_by_Myself" target="_blank">"All By Myself"</a>, which was originally written and performed by <a href="https://en.wikipedia.org/wiki/Eric_Carmen" target="_blank">Eric Carmen</a>, because it borrows heavily from the 2nd movement of <a href="https://en.wikipedia.org/wiki/Piano_Concerto_No._2_(Rachmaninoff)" target="_blank">Rachmaninoff's Piano Concerto No. 2</a>. This video explores Céline Dion's version of this song and how her key change is so iconic, profound, and soul-stirring.
                </p>
            </span>
        </li>
        <li>
            <span>Sound Field (an <b>AMAZING</b> PBS series on YouTube):</span>
            <ul>
            <li>
                <span><a href="https://www.youtube.com/watch?v=QDkpVWGxtWY" target="_blank">How Did The Miseducation of Lauryn Hill Redefine Hip Hop?</a></span>
            </li>
            <li>
                <span><a href="https://www.youtube.com/watch?v=ryTTHmUYc2o" target="_blank">The Genius of Fela Kuti and Afrobeat (feat. Femi & Made Kuti)</a></span>
            </li>
        </ul>
        </li>
        <li>
            <span><a href="https://www.youtube.com/watch?v=leoBccWOZfo" target="_blank">Spinoza: A Complete Guide to Life</a></span>
        </li>
        <li>
            <span><a href="https://www.youtube.com/watch?v=6KC1YrxJma8" target="_blank">A GUIDE TO ABSURDISM: The Philosophy For Living Fully</a></span>
        </li>
        <li>
            <span><a href="https://www.youtube.com/watch?v=DcYLT37ImBY" target="_blank">Training AI to Play Pokemon with Reinforcement Learning</a></span>
            <p>The keywords "Pokémon" and "reinforcement learning" brought me to this video!</p>
        </li>
    </ul>
    <h3>Random articles that stuck with me:</h3>
    <ul>
        <li>
            <span><a href="https://www.haydenplanetarium.org/tyson/commentary/2020-06-03-reflections-on-color-of-my-skin.php" target="_blank"><i>Reflections on the Color of My Skin</i></a><span>
            <p>
                In this article, <a href="https://en.wikipedia.org/wiki/Neil_deGrasse_Tyson" target="_blank">Dr. Tyson</a> reflects on current issues with Black discrimination from the lens of a prolific scientist. To this day, its message is still very relevant.
            </p>
        </li>
        <li>
            <span><a href="https://medium.com/@wcarvalho92/living-divided-between-extreme-happiness-and-extreme-sadness-778a4aec3165" target="_blank">For the “happy people” that suffer from bouts of depression</a>
                <p>
